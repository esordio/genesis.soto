...
<style>
  ...
  @media (max-width:900px){
    ...
    [data-m="label"]{gap:10px !important;}
    [data-m="label"] span,[data-m="proj"] span{padding-top:0 !important;}
...
<div style="background:#EBF2F1;color:#152B2E;font-family:'DM Sans',Helvetica,sans-serif;font-size:17px;line-height:1.65;-webkit-font-smoothing:antialiased;">
  ...
  <section id="investigacion" style="padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      ...
      <div data-m="stack" data-reveal style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
      ...
      <div data-reveal data-m="label" style="margin-top:50px;border-top:1px solid #D6E4E1;padding-top:26px;display:grid;grid-template-columns:auto 1fr;gap:24px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#87A0A0;white-space:nowrap;padding-top:8px;" data-i18n="label-afiliacion">Afiliación</span>
        <p data-i18n="investigacion-tagline" style="margin:0;font-family:'Cormorant Garamond',Georgia,serif;font-style:italic;font-size:22px;line-height:1.45;color:#152B2E;max-width:62ch;text-wrap:pretty;">Actualmente trabajo como asistente de proyectos y coordinadora de tesistas en el laboratorio MicroVet de la Facultad de Ciencias Veterinarias y Pecuarias, Universidad de Chile.</p>
      </div>
    </div>
  </section>
  ...
  <section id="contribucion" style="padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      ...
      <div data-m="proj" data-reveal style="margin-top:36px;display:grid;grid-template-columns:auto 1fr auto;gap:34px;align-items:center;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#87A0A0;white-space:nowrap;padding-top:8px;" data-i18n="label-proyeccion">Proyección</span>
...
class Component extends DCLogic {
  ...
  read() {
    ...
    try {
      const v = localStorage.getItem("site-lang");
  ...
  applyLang() {
    ...
    document.querySelectorAll("[data-i18n]").forEach((el) => {
      ...
      const entry = T[key];
      if (!entry) { console.warn("i18n: falta la clave", key); return; }
      const val = entry[lang];
      if (val === undefined) { console.warn("i18n: falta el idioma", lang, "en", key); return; }
      if (!el.dataset.i18nEs) el.dataset.i18nEs = el.innerHTML;
      el.innerHTML = lang === "es" ? (entry.es !== undefined ? entry.es : el.dataset.i18nEs) : val;
    });
