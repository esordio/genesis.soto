...
<section id="inspiracion">
  <div class="wrap">
    <div class="section-head"><span class="dot"></span><h2>Fuente de inspiración</h2></div>
    <div class="inspiration-grid">
      <div class="inspiration-photo">
        <img src="assets/chubie.jpg" alt="Chubie, la perrita de Génesis" loading="lazy">
      </div>
      <div class="inspiration-text">
        <p>El inicio de esta carrera comenzó el 2018, al querer entrar a estudiar veterinaria para saber cómo cuidar a mi perrita Chubie. Ahora, ocho años después, creo que soy capaz de hacer algo más grande para cuidarla tanto a ella como a otros animales.</p>
