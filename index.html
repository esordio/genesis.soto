...
<style>
  ...
  a{color:#2E5F7F;}
  a:hover{color:#14202B;}
  a:focus-visible,button:focus-visible{outline:1.5px solid #2E5F7F;outline-offset:3px;}
  ::selection{background:#CFE0EA;}
  @keyframes mck-streak{0%{stroke-dashoffset:100;opacity:.9}9%{stroke-dashoffset:0;opacity:.9}70%{opacity:.55}92%{opacity:0}100%{stroke-dashoffset:100;opacity:0}}
  @keyframes mck-serp{0%{stroke-dashoffset:100;opacity:.85}30%{stroke-dashoffset:0;opacity:.85}93%{stroke-dashoffset:0;opacity:.85}97.5%{stroke-dashoffset:0;opacity:0}99.9%{stroke-dashoffset:0;opacity:0}100%{stroke-dashoffset:100;opacity:0}}
  @keyframes mck-colony{0%{opacity:0;transform:scale(.2)}36%{opacity:0;transform:scale(.2)}44%{opacity:1;transform:scale(1)}93%{opacity:1;transform:scale(1)}97%{opacity:0;transform:scale(1)}100%{opacity:0;transform:scale(.2)}}
  @keyframes mck-badge{0%{opacity:0}76%{opacity:0}84%{opacity:1}93%{opacity:1}97%{opacity:0}100%{opacity:0}}
  @keyframes gene-flow{0%{stroke-dashoffset:0}100%{stroke-dashoffset:-36}}
  ...
  @media (prefers-reduced-motion: reduce){
    svg[data-mck] *,[data-genes] *{animation:none !important;opacity:1 !important;transform:none !important;stroke-dashoffset:0 !important;}
  }
</style>
</helmet>

<div style="background:#F4F6F7;color:#14202B;font-family:'DM Sans',Helvetica,sans-serif;font-size:17px;line-height:1.65;-webkit-font-smoothing:antialiased;">

  <header style="position:sticky;top:0;z-index:20;background:rgba(244,246,247,0.93);backdrop-filter:blur(8px);border-bottom:1px solid #E1E7EA;">
    <div style="max-width:1120px;margin:0 auto;padding:15px 40px;display:flex;align-items:center;justify-content:space-between;gap:24px;flex-wrap:wrap;">
      <div style="display:flex;align-items:baseline;gap:12px;">
        <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:19px;letter-spacing:-0.01em;">Génesis Soto Sepúlveda</span>
        <span style="font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;">One Health · AMR</span>
      </div>
      <div style="display:flex;align-items:center;gap:26px;flex-wrap:wrap;">
        <nav style="display:flex;gap:24px;flex-wrap:wrap;">
          <a href="#inspiracion" data-i18n="nav-inspiracion" style="text-decoration:none;color:#56646F;font-size:14px;" style-hover="color:#14202B;">Inspiración</a>
          <a href="#investigacion" data-i18n="nav-investigacion" style="text-decoration:none;color:#56646F;font-size:14px;" style-hover="color:#14202B;">Investigación</a>
          <a href="#especies" data-i18n="nav-especies" style="text-decoration:none;color:#56646F;font-size:14px;" style-hover="color:#14202B;">Especies</a>
          <a href="#contribucion" data-i18n="nav-contribucion" style="text-decoration:none;color:#56646F;font-size:14px;" style-hover="color:#14202B;">Contribución</a>
          <a href="#contacto" data-i18n="nav-contacto" style="text-decoration:none;color:#56646F;font-size:14px;" style-hover="color:#14202B;">Contacto</a>
        </nav>
        <button type="button" onClick="{{ toggleLang }}" data-lang-btn aria-label="Switch language / Cambiar idioma" style="border:1px solid #D3DBE0;background:transparent;color:#56646F;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.12em;padding:6px 13px;border-radius:2px;cursor:pointer;" style-hover="border-color:#2E5F7F;color:#2E5F7F;">EN</button>
      </div>
    </div>
  </header>

  <div style="max-width:1120px;margin:0 auto;padding:74px 40px 82px;display:grid;grid-template-columns:1.04fr 0.96fr;gap:60px;align-items:center;">
    <div>
      <p data-i18n="hero-eyebrow" style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#2E5F7F;margin:0 0 22px;">One Health · Resistencia antimicrobiana</p>
      <h1 style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:500;font-size:68px;line-height:1.02;letter-spacing:-0.015em;margin:0 0 24px;color:#14202B;">Génesis Lucía<br>Soto Sepúlveda</h1>
      <div style="width:56px;height:1px;background:#2E5F7F;margin:0 0 24px;"></div>
      <p data-i18n="hero-role" style="font-size:17px;color:#56646F;margin:0 0 34px;max-width:46ch;text-wrap:pretty;">Médica Veterinaria · Estudiante de Doctorado en Ciencias Silvoagropecuarias y Veterinarias, Universidad de Chile. Investigo la circulación de <em style="font-style:italic;">Escherichia coli</em> resistente entre animales de compañía, aves de producción y el ambiente.</p>
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        <a href="#contacto" data-i18n="btn-primary" style="display:inline-block;padding:12px 26px;background:#14202B;color:#F4F6F7;text-decoration:none;font-size:14.5px;border:1px solid #14202B;border-radius:2px;transition:background .2s ease,border-color .2s ease;" style-hover="background:#2E5F7F;border-color:#2E5F7F;">Escríbeme</a>
        <a href="#investigacion" data-i18n="btn-ghost" style="display:inline-block;padding:12px 26px;background:transparent;color:#14202B;text-decoration:none;font-size:14.5px;border:1px solid #C9D3D9;border-radius:2px;transition:border-color .2s ease,color .2s ease;" style-hover="border-color:#2E5F7F;color:#2E5F7F;">Ver investigación</a>
      </div>
    </div>

    <figure style="margin:0;background:#FFFFFF;border:1px solid #E1E7EA;border-radius:3px;padding:24px 24px 20px;box-shadow:0 20px 44px rgba(20,32,43,0.06);">
  ...
  <circle cx="200" cy="200" r="180" fill="none" stroke="#E6EAEC" stroke-width="7"></circle>
  ...
  <g style="animation:mck-badge 14s ease infinite both;">
    <line x1="196" y1="366" x2="196" y2="382" stroke="#C9D3D9" stroke-width="0.9" stroke-dasharray="3 3"></line>
    <rect x="112" y="382" width="176" height="22" rx="2" fill="#FBF7F5" stroke="#EADDE1" stroke-width="1"></rect>
  ...
  <circle cx="200" cy="200" r="174" fill="url(#mckGlass)" style="pointer-events:none;"></circle>
      ...
      <figcaption style="margin:14px 0 0;border-top:1px solid #EDF1F3;padding-top:14px;">
        <p data-i18n="hero-caption" style="margin:0 0 5px;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.14em;text-transform:uppercase;color:#8A99A6;">Fig. 01 — Agar MacConkey · estriado de Kass</p>
        <p data-i18n="hero-caption-2" style="margin:0;font-size:13.5px;color:#56646F;text-wrap:pretty;">Urocultivo con asa calibrada: la orina se siembra en una línea central y se cruza con un estriado continuo en curvas. Al fermentar lactosa, <em style="font-style:italic;">E. coli</em> acidifica el medio y forma colonias rosadas contables.</p>
        <sc-if value="{{ showPlateLegend }}" hint-placeholder-val="{{ true }}">
          <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px 16px;margin-top:15px;font-family:'JetBrains Mono',monospace;font-size:10.5px;color:#56646F;">
            <div style="display:flex;justify-content:space-between;gap:8px;border-top:1px solid #EDF1F3;padding-top:6px;"><span>Medio</span><span style="color:#8E3350;">Selectivo-diferencial</span></div>
            <div style="display:flex;justify-content:space-between;gap:8px;border-top:1px solid #EDF1F3;padding-top:6px;"><span>Lactosa</span><span style="color:#8E3350;">Fermentador (+)</span></div>
          </div>
          </div>
        </sc-if>
      </figcaption>
  ...
  <section id="inspiracion" style="background:#FFFFFF;border-top:1px solid #E1E7EA;border-bottom:1px solid #E1E7EA;padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div data-reveal style="display:grid;grid-template-columns:auto 1fr;gap:22px;align-items:center;margin-bottom:42px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.16em;color:#8A99A6;">01</span>
        <div style="display:flex;align-items:center;gap:22px;">
          ...
          <span style="flex:1;height:1px;background:#E1E7EA;"></span>
        </div>
      </div>
      <div data-reveal style="display:grid;grid-template-columns:0.78fr 1.22fr;gap:52px;align-items:center;">
        <div style="position:relative;overflow:hidden;border-radius:2px;border:1px solid #E1E7EA;background:#EEF1F1;">
          ...
          <div data-ph style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;background:repeating-linear-gradient(135deg,#E7EBEC 0 8px,#EEF1F1 8px 16px);font-family:'JetBrains Mono',monospace;font-size:11px;color:#8A99A6;text-align:center;padding:16px;">assets/chubie.png</div>
        </div>
        <div>
          <p data-i18n="inspiracion-p" style="margin:0;font-size:23px;line-height:1.5;color:#3B4855;font-family:'Cormorant Garamond',Georgia,serif;text-wrap:pretty;">El inicio de esta carrera comenzó el 2018, al querer entrar a estudiar veterinaria para saber cómo cuidar a mi perrita Chubie. Ahora, ocho años después, creo que soy capaz de hacer algo más grande para cuidarla tanto a ella como a otros animales.</p>
          <p style="margin:22px 0 0;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;">Chubie</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="investigacion" style="padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div data-reveal style="display:grid;grid-template-columns:auto 1fr;gap:22px;align-items:center;margin-bottom:42px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.16em;color:#8A99A6;">02</span>
        <div style="display:flex;align-items:center;gap:22px;">
      ...
      <div data-reveal style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
        <p data-i18n="investigacion-p1" style="margin:0;font-size:16.5px;color:#56646F;text-wrap:pretty;">Aunque solo el 6% de los tutores de mascotas utiliza dietas crudas exclusivas para sus animales de compañía, más del 50% incorpora carne de pollo o sus derivados como snack o complemento en la alimentación de perros y gatos. Al no recibir tratamiento térmico, esta práctica expone a las mascotas a <em style="font-style:italic;">Escherichia coli</em> patógena aviar (APEC), cuya relación genética con las cepas de <em style="font-style:italic;">Escherichia coli</em> uropatógenas (UPEC) circulantes en caninos y felinos aún se desconoce.</p>
        <p data-i18n="investigacion-p2" style="margin:0;font-size:16.5px;color:#56646F;text-wrap:pretty;">Mi investigación de doctorado busca esclarecer ese vínculo, evaluando el rol de las aves de producción como reservorio de patógenos extraintestinales resistentes a antimicrobianos y su capacidad de generar enfermedad entre especies, en el marco de un enfoque One Health que conecta la salud animal, humana y ambiental.</p>
      </div>

      <div data-reveal data-genes style="margin-top:52px;background:#FFFFFF;border:1px solid #E1E7EA;border-radius:2px;padding:30px 32px 26px;">
        <p style="margin:0 0 22px;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.14em;text-transform:uppercase;color:#8A99A6;">Fig. 02 — Genes de virulencia y el vínculo por esclarecer</p>
        <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:26px;align-items:center;">
          <div style="border:1px solid #E1E7EA;border-radius:2px;padding:20px 22px;background:#FCFDFD;">
            <p style="margin:0 0 3px;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.14em;color:#8E3350;">APEC</p>
            <p style="margin:0 0 14px;font-size:13.5px;color:#8A99A6;">Aves de producción</p>
            <div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">iroN</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">ompT</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">hlyF</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">iss</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">iutA</span></div>
          </div>
          <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-width:186px;">
            <div style="font-family:'Cormorant Garamond',Georgia,serif;font-size:44px;line-height:1;color:#A85434;animation:ast-pulse 3.4s ease-in-out infinite;">&#8727;</div>
            <svg viewBox="0 0 186 24" style="width:186px;height:24px;margin-top:6px;overflow:visible;" aria-hidden="true">
              <line x1="8" y1="12" x2="178" y2="12" stroke="#C9D3D9" stroke-width="1.2" stroke-dasharray="6 6" style="animation:gene-flow 1.8s linear infinite;"></line>
              <path d="M178 12 l-8 -4.5 v9 z" fill="#C9D3D9"></path>
              <path d="M8 12 l8 -4.5 v9 z" fill="#C9D3D9"></path>
              <circle cx="24" cy="12" r="4.2" fill="#A85434" style="--gx:138px;animation:gene-travel 9s ease-in-out infinite both;"></circle>
            </svg>
            <p style="margin:8px 0 0;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:#8A99A6;">Relación desconocida</p>
          </div>
          <div style="border:1px solid #E1E7EA;border-radius:2px;padding:20px 22px;background:#FCFDFD;">
            <p style="margin:0 0 3px;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.14em;color:#2E5F7F;">UPEC</p>
            <p style="margin:0 0 14px;font-size:13.5px;color:#8A99A6;">Caninos y felinos</p>
            <div style="display:flex;flex-wrap:wrap;gap:7px;"><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">papC</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">sfaDE</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">hlyA</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">fimH</span><span style="display:inline-block;font-family:'JetBrains Mono',monospace;font-size:11.5px;font-style:italic;color:#3B4855;border:1px solid #DCE3E7;background:#FBFCFC;border-radius:2px;padding:5px 10px;">kpsMII</span></div>
          </div>
        </div>
        <p data-i18n="genes-note" style="margin:22px 0 0;padding-top:16px;border-top:1px solid #EDF1F3;font-size:14px;color:#56646F;text-wrap:pretty;"><span style="color:#A85434;">&#8727;</span> Ambos patotipos comparten factores de virulencia extraintestinal, pero aún se desconoce si las cepas que circulan en aves de producción y en animales de compañía están genéticamente relacionadas: ésa es la pregunta que abre mi tesis.</p>
      </div>
      <div data-reveal style="margin-top:50px;border-top:1px solid #E1E7EA;padding-top:26px;display:grid;grid-template-columns:auto 1fr;gap:24px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;white-space:nowrap;padding-top:8px;">Afiliación</span>
        <p data-i18n="investigacion-tagline" style="margin:0;font-family:'Cormorant Garamond',Georgia,serif;font-style:italic;font-size:22px;line-height:1.45;color:#14202B;max-width:62ch;text-wrap:pretty;">Actualmente trabajo como asistente de proyectos y coordinadora de tesistas en el laboratorio MicroVet de la Facultad de Ciencias Veterinarias y Pecuarias, Universidad de Chile.</p>
      </div>
    </div>
  </section>

  <section id="especies" style="background:#FFFFFF;border-top:1px solid #E1E7EA;border-bottom:1px solid #E1E7EA;padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div data-reveal style="display:grid;grid-template-columns:auto 1fr;gap:22px;align-items:center;margin-bottom:34px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.16em;color:#8A99A6;">03</span>
        <div style="display:flex;align-items:center;gap:22px;">
      ...
      <p data-reveal data-i18n="especies-lede" style="margin:0 0 42px;font-size:16.5px;color:#56646F;max-width:74ch;text-wrap:pretty;">Mi trabajo sigue la ruta que recorre <em style="font-style:italic;">Escherichia coli</em> entre distintos huéspedes: aves de producción, perros y gatos, evaluando la relación entre cepas que circulan en distintas especies bajo un enfoque One Health.</p>
      <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:24px;">

        <article data-reveal style="border:1px solid #E1E7EA;border-radius:2px;background:#FFFFFF;overflow:hidden;transition:box-shadow .35s ease,transform .35s ease;" style-hover="transform:translateY(-4px);box-shadow:0 18px 38px rgba(20,32,43,0.08);">
          <div style="position:relative;background:#F0F3F3;padding:28px 20px;display:flex;align-items:center;justify-content:center;min-height:196px;">
            ...
            <div data-ph style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;background:repeating-linear-gradient(135deg,#E7EBEC 0 8px,#F0F3F3 8px 16px);font-family:'JetBrains Mono',monospace;font-size:11px;color:#8A99A6;">assets/chick.png</div>
          </div>
          <div style="padding:22px 24px 24px;border-top:1px solid #EDF1F3;">
            <p style="margin:0 0 8px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;">Reservorio</p>
            ...
            <p data-i18n="especies-card1-p" style="margin:0 0 16px;font-size:14.5px;color:#56646F;">APEC en pollos broiler</p>
            <a href="#investigacion" data-i18n="especies-link" style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#2E5F7F;text-decoration:none;border-bottom:1px solid #C9D3D9;padding-bottom:2px;" style-hover="border-color:#2E5F7F;">Ver investigación</a>
          </div>
        </article>

        <article data-reveal style="border:1px solid #E1E7EA;border-radius:2px;background:#FFFFFF;overflow:hidden;transition:box-shadow .35s ease,transform .35s ease;" style-hover="transform:translateY(-4px);box-shadow:0 18px 38px rgba(20,32,43,0.08);">
          <div style="position:relative;background:#EFF2F4;padding:28px 20px;display:flex;align-items:center;justify-content:center;min-height:196px;">
            ...
            <div data-ph style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;background:repeating-linear-gradient(135deg,#E7EBEC 0 8px,#EFF2F4 8px 16px);font-family:'JetBrains Mono',monospace;font-size:11px;color:#8A99A6;">assets/puppy.png</div>
          </div>
          <div style="padding:22px 24px 24px;border-top:1px solid #EDF1F3;">
            <p style="margin:0 0 8px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;">Huésped</p>
            ...
            <p data-i18n="especies-card2-p" style="margin:0 0 16px;font-size:14.5px;color:#56646F;">UPEC en perros</p>
            <a href="#investigacion" data-i18n="especies-link" style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#2E5F7F;text-decoration:none;border-bottom:1px solid #C9D3D9;padding-bottom:2px;" style-hover="border-color:#2E5F7F;">Ver investigación</a>
          </div>
        </article>

        <article data-reveal style="border:1px solid #E1E7EA;border-radius:2px;background:#FFFFFF;overflow:hidden;transition:box-shadow .35s ease,transform .35s ease;" style-hover="transform:translateY(-4px);box-shadow:0 18px 38px rgba(20,32,43,0.08);">
          <div style="position:relative;background:#EDF0F2;padding:28px 20px;display:flex;align-items:center;justify-content:center;min-height:196px;">
            ...
            <div data-ph style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;background:repeating-linear-gradient(135deg,#E7EBEC 0 8px,#EDF0F2 8px 16px);font-family:'JetBrains Mono',monospace;font-size:11px;color:#8A99A6;">assets/kitten.png</div>
          </div>
          <div style="padding:22px 24px 24px;border-top:1px solid #EDF1F3;">
            <p style="margin:0 0 8px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;">Huésped</p>
            ...
            <p data-i18n="especies-card3-p" style="margin:0 0 16px;font-size:14.5px;color:#56646F;">UPEC en gatos</p>
            <a href="#investigacion" data-i18n="especies-link" style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#2E5F7F;text-decoration:none;border-bottom:1px solid #C9D3D9;padding-bottom:2px;" style-hover="border-color:#2E5F7F;">Ver investigación</a>
          </div>
        </article>
  ...
  <section id="contribucion" style="padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div data-reveal style="display:grid;grid-template-columns:auto 1fr;gap:22px;align-items:center;margin-bottom:42px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.16em;color:#8A99A6;">04</span>
        <div style="display:flex;align-items:center;gap:22px;">
      ...
      <article data-reveal style="background:#FFFFFF;border:1px solid #E1E7EA;border-radius:2px;padding:38px 40px;display:grid;grid-template-columns:0.34fr 0.66fr;gap:40px;">
        <div>
          <p data-i18n="contribucion-label" style="margin:0 0 10px;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#2E5F7F;">Memoria de título · 2025</p>
          <h3 data-i18n="contribucion-h3" style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:500;font-size:25px;line-height:1.25;margin:0;color:#14202B;text-wrap:pretty;">Oxitetraciclina en el entorno productivo de pollos broiler: efecto sobre la resistencia antimicrobiana y la formación de biopelículas de <em style="font-style:italic;">Escherichia coli</em></h3>
        </div>
        <div>
          <p data-i18n="contribucion-desc" style="margin:0;font-size:16.5px;color:#56646F;text-wrap:pretty;">Este trabajo mostró que el tratamiento con oxitetraciclina en pollos broiler favorece la aparición de <em style="font-style:italic;">E. coli</em> resistente a tetraciclinas en camas, deyecciones, comederos y bebederos, y que esa resistencia se asocia a una mayor formación de biopelículas. La capacidad de formar biopelículas disminuyó a medida que bajaba la concentración del antimicrobiano en el ambiente, lo que sugiere que estas comunidades bacterianas actúan como un mecanismo de persistencia de la resistencia dentro de la producción avícola y un punto crítico para su diseminación hacia la cadena alimentaria.</p>
          
        </div>
      </article>
      <div data-reveal style="margin-top:36px;display:grid;grid-template-columns:auto 1fr auto;gap:34px;align-items:center;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:#8A99A6;white-space:nowrap;padding-top:8px;">Proyección</span>
        <p data-i18n="contribucion-tagline" style="margin:0;font-family:'Cormorant Garamond',Georgia,serif;font-style:italic;font-size:22px;line-height:1.45;color:#14202B;max-width:62ch;text-wrap:pretty;">Quiero seguir contribuyendo a la comunidad, aportando las bases que permitan mejorar la regularización de la ingesta de antimicrobianos en el área animal.</p>
          <div style="position:relative;flex:none;width:216px;">
            <img src="assets/one-health.png" alt="Diagrama de One Health: la intersección entre salud humana, salud animal y salud ambiental." loading="lazy" onError="{{ imgFallback }}" style="display:block;width:100%;height:auto;">
            <div data-ph style="display:none;align-items:center;justify-content:center;height:206px;background:repeating-linear-gradient(135deg,#E7EBEC 0 8px,#F4F6F7 8px 16px);font-family:'JetBrains Mono',monospace;font-size:10.5px;color:#8A99A6;text-align:center;padding:14px;">assets/one-health.png</div>
          </div>
      </div>
    </div>
  </section>

  <section id="contacto" style="background:#14202B;color:#EAEFF2;padding:86px 0;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div data-reveal style="display:grid;grid-template-columns:auto 1fr;gap:22px;align-items:center;margin-bottom:44px;">
        <span style="font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.16em;color:#7F8F9C;">05</span>
        <div style="display:flex;align-items:center;gap:22px;">
          <h2 data-i18n="contacto-h2" style="font-family:'Cormorant Garamond',Georgia,serif;font-weight:500;font-size:32px;margin:0;letter-spacing:-0.01em;color:#F4F6F7;">Contacto</h2>
          <span style="flex:1;height:1px;background:rgba(255,255,255,0.14);"></span>
        </div>
      </div>
      <div data-reveal style="display:grid;grid-template-columns:1fr auto;gap:56px;align-items:center;">
        <div>
          <p data-i18n="contacto-p" style="margin:0 0 26px;font-family:'Cormorant Garamond',Georgia,serif;font-size:25px;line-height:1.35;color:#EAEFF2;max-width:34ch;text-wrap:pretty;">Para consultas académicas, colaboraciones o preguntas sobre mi investigación, escríbeme directamente.</p>
          <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <a href="mailto:genesis.soto@ug.uchile.cl" aria-label="Enviarme un correo" style="display:inline-flex;align-items:center;gap:10px;padding:11px 22px;border:1px solid rgba(255,255,255,0.3);border-radius:2px;text-decoration:none;color:#F4F6F7;font-size:14.5px;transition:background .2s ease,border-color .2s ease;" style-hover="background:rgba(255,255,255,0.08);border-color:#F4F6F7;">
            ...
            <a href="https://www.linkedin.com/in/génesis-soto-b24598362" target="_blank" rel="noopener" aria-label="Ver mi perfil de LinkedIn" style="display:inline-flex;align-items:center;gap:10px;padding:11px 22px;border:1px solid rgba(255,255,255,0.3);border-radius:2px;text-decoration:none;color:#F4F6F7;font-size:14.5px;transition:background .2s ease,border-color .2s ease;" style-hover="background:rgba(255,255,255,0.08);border-color:#F4F6F7;">
        ...
        <sc-if value="{{ showQr }}" hint-placeholder-val="{{ true }}">
          <div style="position:relative;width:164px;height:164px;border:1px solid rgba(255,255,255,0.24);border-radius:2px;background:rgba(255,255,255,0.05);display:flex;align-items:center;justify-content:center;padding:12px;">
            <img src="assets/qr.png" alt="Código QR de contacto" loading="lazy" onError="{{ imgFallback }}" style="width:100%;height:100%;object-fit:contain;display:block;">
            <div data-ph style="display:none;position:absolute;inset:12px;align-items:center;justify-content:center;text-align:center;font-family:'JetBrains Mono',monospace;font-size:10.5px;line-height:1.5;color:#7F8F9C;" data-i18n="qr-placeholder">Coloca aquí tu código QR<br>(assets/qr.png)</div>
          </div>
        </sc-if>
      </div>
    </div>
  ...
  <footer style="background:#0E1721;color:#7F8F9C;padding:34px 0 40px;">
    <div style="max-width:1120px;margin:0 auto;padding:0 40px;">
      <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;padding-bottom:20px;">
        <p style="margin:0;font-size:13px;">Génesis Soto Sepúlveda · Santiago, Chile</p>
        <div style="display:flex;gap:6px;" aria-hidden="true">
          <span style="width:6px;height:6px;border-radius:50%;background:#2E5F7F;"></span>
          <span style="width:6px;height:6px;border-radius:50%;background:#4C6E86;"></span>
          <span style="width:6px;height:6px;border-radius:50%;background:#2A3946;"></span>
        </div>
      </div>
      <sc-if value="{{ showAiDisclosure }}" hint-placeholder-val="{{ true }}">
        <p data-i18n="ai-disclosure" style="margin:0;padding-top:18px;border-top:1px solid rgba(255,255,255,0.1);font-size:12px;line-height:1.65;max-width:78ch;"><strong style="color:#B9C6CF;font-weight:500;">Declaración de uso de IA:</strong> utilicé Claude [Sonnet 5, el 1 de septiembre de 2026] para generar la página y animaciones, basado en texto incorporado a la herramienta, para finalmente aceptar el contenido que reflejaba mis ideas. Revisé y verifiqué que el contenido fuera mi voz y mis ideas; la responsabilidad final es mía.</p>
      </sc-if>
    </div>
  </footer>
</div>
</x-dc>
<script type="text/x-dc" data-dc-script data-props="{&quot;showPlateLegend&quot;:{&quot;editor&quot;:&quot;boolean&quot;,&quot;default&quot;:true,&quot;tsType&quot;:&quot;boolean&quot;,&quot;section&quot;:&quot;Contenido&quot;},&quot;showQr&quot;:{&quot;editor&quot;:&quot;boolean&quot;,&quot;default&quot;:true,&quot;tsType&quot;:&quot;boolean&quot;,&quot;section&quot;:&quot;Contenido&quot;},&quot;showAiDisclosure&quot;:{&quot;editor&quot;:&quot;boolean&quot;,&quot;default&quot;:true,&quot;tsType&quot;:&quot;boolean&quot;,&quot;section&quot;:&quot;Contenido&quot;}}">
const T = {
  ...
  "hero-role": {
    es: 'Médica Veterinaria · Estudiante de Doctorado en Ciencias Silvoagropecuarias y Veterinarias, Universidad de Chile. Investigo la circulación de <em style="font-style:italic">Escherichia coli</em> resistente entre animales de compañía, aves de producción y el ambiente.',
    en: 'Veterinarian · PhD student in Silvoagricultural and Veterinary Sciences, Universidad de Chile. I study the circulation of resistant <em style="font-style:italic">Escherichia coli</em> between companion animals, production poultry, and the environment.'
  },
  "btn-primary": { es: "Escríbeme", en: "Email me" },
  "btn-ghost": { es: "Ver investigación", en: "See research" },
  "hero-caption": { es: "Fig. 01 — Agar MacConkey · estriado de Kass", en: "Fig. 01 — Broth microdilution" },
  "hero-caption-2": {
    es: 'Urocultivo con asa calibrada: la orina se siembra en una línea central y se cruza con un estriado continuo en curvas. Al fermentar lactosa, <em style="font-style:italic">E. coli</em> acidifica el medio y forma colonias rosadas contables.',
    en: 'Urine culture with a calibrated loop: the sample is streaked along a central line and crossed with a single continuous serpentine streak. By fermenting lactose, <em style="font-style:italic">E. coli</em> acidifies the medium and forms countable pink colonies.'
  },
  ...
  "investigacion-p1": {
    ...
    en: 'Although only 6% of pet owners feed their companion animals an exclusively raw diet, more than 50% give chicken meat or its by-products as a treat or supplement to dogs and cats. Since this meat receives no heat treatment, the practice exposes pets to avian pathogenic <em style="font-style:italic">Escherichia coli</em> (APEC), whose genetic relationship with the uropathogenic <em style="font-style:italic">Escherichia coli</em> (UPEC) strains circulating in dogs and cats is still unknown.'
  },
  "investigacion-p2": {
  ...
  "especies-lede": {
    es: 'Mi trabajo sigue la ruta que recorre <em style="font-style:italic">Escherichia coli</em> entre distintos huéspedes: aves de producción, perros y gatos, evaluando la relación entre cepas que circulan en distintas especies bajo un enfoque One Health.',
    en: 'My work follows the route that <em style="font-style:italic">Escherichia coli</em> travels between different hosts — production poultry, dogs, and cats — evaluating the relationship between strains circulating across species under a One Health approach.'
  },
  ...
  "genes-note": {
    es: '<span style="color:#A85434">&#8727;</span> Ambos patotipos comparten factores de virulencia extraintestinal, pero aún se desconoce si las cepas que circulan en aves de producción y en animales de compañía están genéticamente relacionadas: ésa es la pregunta que abre mi tesis.',
    en: '<span style="color:#A85434">&#8727;</span> Both pathotypes share extraintestinal virulence factors, yet it is still unknown whether the strains circulating in production poultry and in companion animals are genetically related: that is the question my thesis opens.'
  },
...
class Component extends DCLogic {
  ...
  componentDidMount() {
    try { this.lang = localStorage.getItem("site-lang") || "es"; } catch (e) {}
    if (this.lang !== "es") this.applyLang();
  ...
  syncButton() {
    ...
    if (btn) btn.textContent = this.lang === "es" ? "EN" : "ES";
  }
  ...
  renderVals() {
    return {
      showPlateLegend: this.props.showPlateLegend ?? true,
      showQr: this.props.showQr ?? true,
      showAiDisclosure: this.props.showAiDisclosure ?? true,
      toggleLang: () => {
